...
<template>
  <AppLayout>
    ...
    <div v-for="(movies, index) in movie" :key="index">
  <div v-if="movies.movie_id === 16" class="movie-card-container">
    <div class="movie-card">
      ...
      <div class="card-content">
        ...
        <p>
          ...
          <a v-bind:href="movies.trailer" target="_blank">ดูตัวอย่าง🔴</a>
        </p>
      </div>
      </div>
    </div>
